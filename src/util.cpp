...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\NAV
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\NAV
    // Mac: ~/Library/Application Support/NAV
    // Unix: ~/.NAV
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "NAV";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "NAV.conf"));
...
// If nobody has a time different than ours but within 5 minutes of ours, give a warning
                ...
                {
                    fDone = true;
                    string strMessage = _("Warning: Please check that your computer's date and time are correct! If your clock is wrong NAV will not work properly.");
