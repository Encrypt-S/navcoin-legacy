...
public:
    ...
    void setupUi(QDialog *RPCConsole)
    {
        ...
        openDebugLogfileButton->setStyleSheet(QLatin1String("background-color: qlineargradient(spread:pad, x1:0, y1:1, x2:0, y2:0, stop:0 rgb(240,240,240), stop:1 rgb(255, 255, 255));\n"
"border-radius:3px;\n"
...
"padding: 4px 12px;"));
        ...
        showCLOptionsButton->setStyleSheet(QLatin1String("background-color: qlineargradient(spread:pad, x1:0, y1:1, x2:0, y2:0, stop:0 rgb(240,240,240), stop:1 rgb(255, 255, 255));\n"
"border-radius:3px;\n"
"border: 1px solid #C4C1BD;\n"
"color: #4C4C4C;\n"
"padding: 4px 12px;"));
...
""));
    ...
    {
        RPCConsole->setWindowTitle(QApplication::translate("RPCConsole", "NavCoin - Debug window", 0));
        label_9->setText(QApplication::translate("RPCConsole", "NavanjoAnonBeta Core", 0));
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the NavCoin debug log file from the current data directory. This can take a few seconds for large log files.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        showCLOptionsButton->setToolTip(QApplication::translate("RPCConsole", "Show the NavCoin-Qt help message to get a list with possible NavCoin command-line options.", 0));
#endif // QT_NO_TOOLTIP
