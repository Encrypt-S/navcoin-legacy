...
#include "../src/qt/rpcchatwindow.h"
...
static const uint qt_meta_data_RpcChatWindow[] = {
...
void RpcChatWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        RpcChatWindow *_t = static_cast<RpcChatWindow *>(_o);
        switch (_id) {
        ...
        {
            typedef void (RpcChatWindow::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&RpcChatWindow::changeTab)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject *RpcChatWindow::metaObject() const
{
...
int RpcChatWindow::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
