...
public:
    ...
    void setupUi(QDialog *AboutDialog)
    {
        ...
        versionLabel->setText(QStringLiteral("3.3.0 - UT-ZAH"));
...
"padding: 4px 12px;"));
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About NavCoin", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>NavCoin</b> version", 0));
        copyrightLabel->setText(QApplication::translate("AboutDialog", "<html><head/><body><p>Copyright \302\251 2014 - 2015 The SummerCoin Developers<br />Copyright \302\251 2014 - 2015 The NavCoin Developers<br />Copyright \302\251 2014 - 2015 The NavAnonBeta Developers</p></body></html>", 0));
