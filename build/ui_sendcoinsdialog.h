...
public:
    ...
    QCheckBox *coinSwapCheckbox;
    QHBoxLayout *horizontalLayout_3;
    QLabel *label_2;
    QLineEdit *nav2Address;
    ...
    void setupUi(QDialog *SendCoinsDialog)
    {
        ...
        coinSwapCheckbox = new QCheckBox(SendCoinsDialog);
        coinSwapCheckbox->setObjectName(QStringLiteral("coinSwapCheckbox"));

        horizontalLayoutTxComment->addWidget(coinSwapCheckbox);
        ...
        nav2Address = new QLineEdit(SendCoinsDialog);
        nav2Address->setObjectName(QStringLiteral("nav2Address"));

        horizontalLayout_3->addWidget(nav2Address);
        ...
        pushButtonCoinControl->setStyleSheet(QLatin1String("background-color: qlineargradient(spread:pad, x1:0, y1:1, x2:0, y2:0, stop:0 rgb(240,240,240), stop:1 rgb(255, 255, 255));\n"
"border-radius:3px;\n"
...
"padding: 4px 12px;"));
        ...
        lineEditCoinControlChange->setStyleSheet(QLatin1String("background-color: rgb(255,255,255);\n"
"border-radius:3px;\n"
"border: 1px solid #C4C1BD;\n"
"color: #4C4C4C;\n"
"padding: 4px;"));
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 830, 84));
        ...
        clearButton->setStyleSheet(QLatin1String("background-color: qlineargradient(spread:pad, x1:0, y1:1, x2:0, y2:0, stop:0 rgb(240,240,240), stop:1 rgb(255, 255, 255));\n"
"border-radius:3px;\n"
"border: 1px solid #C4C1BD;\n"
"color: #4C4C4C;\n"
"padding: 4px 12px;\n"
"margin: 0px 6px 0px 0px;"));
        ...
        sendButton->setStyleSheet(QLatin1String("background-color: qlineargradient(spread:pad, x1:0, y1:1, x2:0, y2:0, stop:0 rgb(240,240,240), stop:1 rgb(255, 255, 255));\n"
"border-radius:3px;\n"
"border: 1px solid #C4C1BD;\n"
"color: #4C4C4C;\n"
"padding: 4px 12px;"));
    ...
    void retranslateUi(QDialog *SendCoinsDialog)
    {
        ...
        coinSwapCheckbox->setText(QApplication::translate("SendCoinsDialog", "Swap Nav for Nav 2.0", 0));
        label_2->setText(QApplication::translate("SendCoinsDialog", "Nav 2.0 Address", 0));
        ...
        labelCoinControlAmount->setText(QApplication::translate("SendCoinsDialog", "0.00 NAB", 0));
        ...
        labelCoinControlFee->setText(QApplication::translate("SendCoinsDialog", "0.00 NAB", 0));
        ...
        labelCoinControlAfterFee->setText(QApplication::translate("SendCoinsDialog", "0.00 NAB", 0));
        ...
        labelBalance->setText(QApplication::translate("SendCoinsDialog", "123.456 NAB", 0));
#ifndef QT_NO_TOOLTIP
